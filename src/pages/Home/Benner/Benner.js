    ...
    return (
        <Carousel infiniteLoop autoPlay showThumbs={false} showIndicators={false} autoFocus={false}>
                    ...
                    <Container className="legend bg-transparent" style={{top:'30%'}} >
                        <Row>
                            <Col md={6} className='text-start ms-5'>
                                ...
                                <h1 className='text-uppercase benner-text' >Vacation</h1>
                                <p className='fs-sm-5'>Bern, switzerland</p>
                    ...
                    <Container className="legend bg-transparent" style={{top:'30%'}} >
                        <Row>
                            <Col md={7} className='text-start ms-5 '>
                                <h1 className='text-uppercase text-primary' >special</h1>
                                <h1 className='text-uppercase benner-text'  >5 days in italy</h1>
                                <p className='fs-sm-5'>Italy , Rome</p>
                ...
                <div>
                    ...
                    <Container className="legend bg-transparent" style={{top:'30%'}} >
                        <Row>
                            <Col md={6} lg={8} className='text-start ms-5'>
                                <h1 className='fs-sm-1 text-warning text-uppercase'>Open your eyes to</h1>
                                <h1 className='text-uppercase  benner-text' >The hidden world</h1>
